---
layout: default
title: "Cladonia spp.: Cladonia arbuscula, C. mitis, C. rangiferina, C. stellaris, C. stygia — reindeer lichens: tree reindeer lichen, green reindeer lichen, gray reindeer lichen, star-tipped reindeer lichen, black-footed reindeer lichen"
abbreviation: CLASPP
common_name: "reindeer lichens: tree reindeer lichen, green reindeer lichen, gray reindeer lichen, star-tipped reindeer lichen, black-footed reindeer lichen"
scientific_name: "Cladonia spp.: Cladonia arbuscula, C. mitis, C. rangiferina, C. stellaris, C. stygia"
...
# Cladonia spp.: Cladonia arbuscula, C. mitis, C. rangiferina, C. stellaris, C. stygia — reindeer lichens: tree reindeer lichen, green reindeer lichen, gray reindeer lichen, star-tipped reindeer lichen, black-footed reindeer lichen
...
Munger, Gregory T. 2008. _Cladonia_ spp., reindeer lichens In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/claspp
...
Photo © lordnone, iNaturalist.org, some rights reserved. 

Star-tipped reindeer lichen ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>))

## Taxonomy

Many systematists place reindeer lichens in the genus is _Cladonia P._ Browne [3,4,56,64,124], although some systematists place reindeer lichens in the genus _Cladina_ [24,135]. Reindeer lichens are in the family Cladoniaceae [3,4,24,56,64,124,135].

The taxonomic status of _Cladonia spp_. is in question [124]. A study of phylogenetic relationships within _Cladonia_ and _Cladina_ species based on DNA sequences, morphology, and chemical analyses led some researchers to conclude that _Cladina_ is best treated as a subgenus of _Cladonia_ [4,124].

The reindeer lichens discussed in this review are listed below.

 * _**Cladonia arbuscula**_(Wallr.) Flotow [4,64,124], tree reindeer lichen
 * _Cladonia arbuscula_ subsp. _arbuscula_ (Wallr.) Flot. [3,64]
 * _Cladonia arbuscula_ subsp. _beringiana_ (Ahti) N.S. Golubk. [3,23,64]
 * _Cladonia arbuscula_ subsp. _boliviana_ (Ahti) Ahti & DePri
 * _Cladonia arbuscula_ subsp. _imshaugii_ (Ahti) Ahti & DePriest
 * _Cladonia arbuscula_ subsp._pachyderma_ (Ahti) Ahti & DePriest
 * _Cladonia arbuscula_ subsp. _squarrosa_ (Wallr.) Ruoss
 * _Cladonia arbuscula_ subsp. _stictica_ Ruoss [64]
 * _**Cladonia mitis**_ Sandst. [4,64,124], green reindeer lichen
 * _**Cladonia rangiferina**_ (L.) Weber ex F.H. Wigg. [4,64,124], gray reindeer lichen
 * _Cladonia rangiferina_ subsp. _abbayesii_ (Ahti) Ahti & DePriest
 * _Cladonia rangiferina_ subsp. _grisea_ Ahti
 * _Cladonia rangiferina_ subsp. _rangiferina_ (L.) Weber ex F.H. Wigg.
 * _**Cladonia stellaris**_ (Opiz) Pouzar & Vezda [4,24,124,135], star-tipped reindeer lichen
 * _**Cladonia stygia**_(Fr.) Ruoss [4,64,124], black-footed reindeer lichen

### Synonyms

for _**Cladonia arbuscula:**_

 * _Cladina arbuscula_ (Wallr.) Hale & Culb. [24,85,135]
 * _Cladonia arbuscula_ var. _arbuscula_(Wallr.) Flot. (cited in [64])
 * _Cladonia sylvatica_ (L.) Hoffm. [56]

for _**Cladonia mitis** :_

 * _Cladina mitis_ (Sandst.) Hustich [24,85,135]
 * _Cladonia arbuscula_ subsp. _mitis_ (Sandst.) Ruoss
 * _Cladonia arbuscula_ var._mitis_(Sandst.) Sipman (cited in [64])

for _**Cladonia rangiferina** :_

 * _Cladina rangiferina_ (L.) Nyl. [24,85,135]
 * _Cladonia rangiferina_ var. _abbayesii_ Ahti
 * _Cladonia rangiferina_ var. _rangiferina_ (L.) Weber ex F.H. Wigg. (cited in [64])

for _**Cladonia stellaris:**_

 * _Cenomyce stellaris_ Opiz (cited in [64])
 * _Cladina stellaris_ (Opiz) Brodo [22]

for _**Cladonia stygia:**_

 * _Cladina stygia_ (Fr.) Ahti [24,135]
...
Photo © Jim Panchuk, iNaturalist.org, some rights reserved. 

Gray reindeer lichen ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>))
 ...
 * Black spruce/lichen forest subtype with a "well-developed lichen carpet" of primarily Cladonia stellaris, C. mitis, and C. rangiferina, recognized by the Society of American Foresters [34]
 * Jack pine/lichen forest subtype, characterized by a dense reindeer lichen ground layer, also recognized by the Society of American Foresters [82]. 

### **United States**

**Alaska:**

 * White spruce-black spruce/willow/mountain cranberry (Salix spp./Vaccinium vitis-idaea)/C. rangiferina forest type [144]
 * White spruce/dwarf birch (Betula nana)/reindeer lichen vegetation unit [138]
 * White spruce/thinleaf alder/kinnikinnick/snow lichen (Alnus incana subsp. tenuifolia/Arctostaphylos uva-ursi/Stereocaulon spp.)-reindeer lichen woodland [43]
 * White spruce/reindeer lichen woodland vegetation type on gently rolling, stabilized sand dunes in Kobuk Valley National Park [102]
 * Mature black spruce-white spruce/bog birch (B. glandulosa)/lichen forest [46]
 * Black spruce/willow/splendid feather moss (Hylocomium splendens)/C. rangiferina forest type
 * Black spruce/prickly rose/horsetail (Rosa acicularis/Equisetum spp.)/C. rangiferina forest community in the Porcupine River and upper Yukon River drainages [144]
 * Black spruce/sphagnum (Sphagnum spp.)-reindeer lichen type [46,138]
 * Black spruce/moss-lichen mature forest community [46]
 * Black spruce/splendid feather moss-reindeer lichen vegetation type [138]
 * Black spruce/reindeer lichen vegetation type in Kobuk Valley National Park [102]
 * Black spruce/reindeer lichen vegetation [138]
 * Black spruce/lichen rangeland cover type, recognized by the Society for Range Management [129]
 * Bog blueberry-black crowberry (V. uliginosum-Empetrum nigrum)-dwarf birch-Labrador tea (Ledum spp.)-mountain cranberry/cetraria lichen (Cetraria spp.)-reindeer lichen-snow lichen (Stereocaulon paschale) tundra vegetation type in the Bering Land Bridge National Preserve [103]
 * Lichen tundra rangeland cover type, recognized by the Society for Range Management [130]

**West Virginia:**

 * Polytrichum moss (Polytrichum spp.)-reindeer lichen association [35]

### **Canada**

**Western Canada (general):**

 * Rocky Mountain lodgepole pine/bog Labrador tea (Pinus contorta var. latifolia/L. groenlandicum)/Cladonia mitis community type [127]
 * Alberta:
 * Rocky Mountain lodgepole pine/velvetleaf blueberry (V. myrtilloides)/reindeer lichen forest community type in west-central Alberta [30]

**Alberta/Saskatchewan:**

 * Jack pine-black spruce/bog Labrador tea/reindeer lichen community
 * Jack pine/velvetleaf blueberry/C. mitis community
 * Jack pine/C. mitis community in northeastern Alberta and northern Saskatchewan [28]

**British Columbia:**

 * Black spruce/C. stellaris midseral, upland forest association [73]

**Labrador:**

 * Sheep-laurel (Kalmia angustifolia)/C. stellaris-C. rangiferina raised bog community in southeastern Labrador [49]

**Manitoba:**

 * Black spruce/reindeer lichen vegetation type in northern Manitoba [146] 
Newfoundland:
 * Black spruce/sheep-laurel/reindeer lichen forest type [87]
 * Sheep-laurel-blueberry (Vaccinium spp.)/reindeer lichen maritime lichen-heath association
 * Sheep-laurel/rhacomitrium moss (Rhacomitrium lanuginosum)-reindeer lichen maritime lichen-heath association [1]
 * Saskatchewan:
 * Black spruce/mountain cranberry/Schreber's moss (Pleurozium schreberi)-C. mitis community in central Saskatchewan
 * Jack pine/mountain cranberry/Schreber's moss-C. mitis community in central Saskatchewan [105]
...
Photo © Igor Balashov, iNaturalist.org, some rights reserved 
...
Photo © cjlewis, iNaturalist.org, some rights reserved. 

Black-footed reindeer lichen ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>))
...
Many studies have reported reindeer lichen survival in protected sites that were either missed by fire or burned with extremely low severity [28,108,116]. For more on reindeer lichen regeneration and/or survival on burned plots, see below.

## Lichen Response to Fire
...
Average percent cover of reindeer lichens in northern Quebec [9].Years since fire| 0-30| 31-50| 51-90| >90 
---|---|---|---|--- 
Number of sites| 5| 10| 12| 38 
 _C. mitis_| 2| 22| 23| 5 
 _C. rangiferina_| 1| 1| 4| 7 
 _C. stellaris_| 0| 5| 25| 48 
...
Average percent frequency/percent cover of reindeer lichens in 7- to 36-year-old black spruce-tamarack stands [16].**Years since fire**| 7| 10| 14| 22| 32| 36 
---|---|---|---|---|---|--- 
 _C. rangiferina_| 0| 7/<1| 100/2| 67/8| 60/2| 80/13 
 _C. arbuscula_| 0| 10/<1| 97/1| 73/9| 53/4| 80/3 
 _C. stellaris_| 0| 0| 5/<1| 13/<1| 0| 10/<1 
...
Average cover of reindeer lichens with increasing time since fire in boreal jack pine-spruce forests from the Northwest Territories and Saskatchewan [132]Years since fire| 1-20| 21-40| 41-60| 61-80| 81-100| 101-150| 151-200| 201-250| 251-300 
---|---|---|---|---|---|---|---|---|--- 
 _C. mitis_ and _C. stellaris_| 0.8| 3| 21.4| 29.6| 35.9| 24.7| 22.5| 20.3| 16.7 
 _C. rangiferina_| 0| 0| 0.9| 1.1| 2.9| 2.4| 5.2| 5.7| 7 
...
Relative frequency of reindeer lichens along a boreal forest postfire successional gradient in central Quebec (adapted from [48]).Years since fire| <10 years| 24 and 28 years| 50 and 51 years| 71 and 110 years 
---|---|---|---|--- 
 _C. mitis_| 0.004| 37.7| 43.4| 30.8 
 _C. rangiferina_| 0.004| 12.7| 23.6| 27.6 
 _C. stellaris_| 0| 2.2| 2| 74 
...
Average percent cover of reindeer lichens 57 years after severe and reduced severity crown fire in jack pine-black spruce forests in northwestern Quebec [7].Species| Severe crown fire, open canopy| Reduced severity crown fire, closed canopy 
---|---|--- 
 _C. mitis_| 42.8| 28.4 
 _C. rangiferina_| 13.5| 20.3 
 _C. stellaris_| 13.9| 20.3 
 
For information on prescribed fire and postfire responses of reindeer lichens and many plant species, see these FEIS Research Project Summaries:
...
Table A1 provides fire regime information that may be relevant to reindeer lichens. Included are only those vegetation communities for which published information confirms, or strongly implies, reindeer lichen occurrence. Because site tolerances and distributions for reindeer lichens are incomplete and many reindeer lichen habitats do not burn, such as rocky outcrops and talus slopes, other reindeer lichen habitats may also be missing from the fire regime table. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type.

## Fire Management Considerations

Reindeer lichens are an important caribou food source (see Importance to Wildlife and Livestock and the FEIS Species Review on caribou). Maintenance of this food source is an important fire management consideration in reindeer lichen habitats. Extended periods of fire exclusion can be detrimental to reindeer lichen cover and caribou rangelands (see Fire Regimes: Fire as a regeneration process). After fire, several decades may be required to regain reindeer lichen groundlayer dominance. Site conditions, postfire grazing, and fire severity may affect reindeer lichen recovery on burned sites. In Scot's pine forests of Sweden, reindeer lichen recovery was slow, and C. stellaris populations were not "grazable" for at least 130 years [123]. Long-term planning is necessary to ensure suitable caribou grazing is maintained [86].
...
135\. U.S. Department of Agriculture, Natural Resources Conservation Service. 2016. PLANTS Database, [Online]. Available: https://plants.usda.gov /. [34262]
