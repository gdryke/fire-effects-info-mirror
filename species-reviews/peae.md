---
layout: default
title: "Peucaea aestivalis — Bachman's sparrow"
abbreviation: PEAE
common_name: "Bachman's sparrow"
scientific_name: Peucaea aestivalis
...
Meyer, Rachelle. 2006. _Peucaea aestivalis_ , Bachman's sparrow. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/peae

## Introduction

## Taxonomy

 _Peucaea aestivalis_ (Lichtenstein) is the scientific name of the Bachman's sparrow, a member of the Emberizidae family[3].

Three subspecies are recognized by the American Ornithologists' Union [2]:

 * _Peucaea aestivalis aestivalis_(Lichtenstein)
 * _Peucaea aestivalis bachmani_ (Audubon)
 * _Peucaea aestivalis illinoensis_(Ridgeway)

### Synonyms

 * _Aimophila aestivalis_ (Lichtenstein)
...
According to literature reviews, Bachman's sparrows occur primarily in the southeastern United States from the central region of peninsular Florida north to limited areas of extreme southern Virginia and west through portions of Tennessee, Kentucky and Missouri to eastern Oklahoma and eastern Texas [19,47]. Bachman's sparrows may rarely occur in more northerly areas that were part of their historic breeding range, including most of Illinois, Indiana, Ohio, West Virginia and parts of Pennsylvania and Maryland [19,45,62]. A map of the Bachman's sparrow's historic and current distribution can be found at NatureServe by clicking the species database link and performing a search.

Reviews also describe the range of the 3 subspecies of Bachman's sparrow. _Peucaea aestivalis aestivalis_ breeds furthest east, from southeast South Carolina to peninsular Florida. _Peucaea a. bachmanii_ occurs west of _P. a. aestivalis_ to Mississippi and north to Kentucky. _Peucaea a. illinoensis_ occurs in the westernmost region of the species' range [19,47,62]. Since subspecies are typically not distinguished in the literature, they will not be discussed further in this review.

The plant association lists in Table A1 are speculative and are based on the habitat characteristics and species composition of communities Bachman's sparrows are known to occupy. There is not conclusive evidence that Bachman's sparrows occur in all the habitat types listed, and some community types, especially those used rarely, may have been omitted.

### States and Provinces

 * United States: AL AR FL GA KY LA MD MS MO NC OK SC TN TX VA WV

## Plant Communities

In addition to the community types listed in Table A1, Bachman's sparrows commonly occur in clearcuts. Bachman's sparrows have been reported in clearcuts recently planted with loblolly pine (_Pinus taeda_), shortleaf pine (_P. echinata_), and/or longleaf pine (_P. palustris_) [5,30,63]. Bachman's sparrows were present in a young longleaf pine plantation in South Carolina where the predominant understory species were bluestems (_Andropogon_ spp.) and panicgrass (_Panicum_ spp.) [63]. In northern Florida, Bachman's sparrow occurred in young (2-4 yr) clearcuts comprised of slash pine (_Pinus elliottii_), inkberry (_Ilex glabra_), saw-palmetto (_Serenoa repens_), oaks (_Quercus_ spp.), and blackberry (_Rubus_ spp.) [8].
...
**Predators:** Data demonstrating which species prey on Bachman's sparrow are lacking. However short-tailed hawks (_Buteo brachyurus_) [48] and possibly American kestrels (_Falco sparverius_) [14] prey on adult Bachman's sparrows. Species responsible for nest predation are not generally known [30,50]. Evidence in 2 studies suggest mammalian predators [30,63] and snakes eat Bachman's sparrow nestlings [30].

Bachman's sparrow nests are occasionally parasitized by brown-headed cowbirds (_Molothrus ater_) [26,30]. In shortleaf and loblolly pine plantations of central Arkansas, 5% of 38 nest failures were due to brown-headed cowbird parasitism [30].
...
Photo by Eric Soehren, iNaturalist.org, some rights reserved. 

Bachman's sparrow nest habitat in a longleaf pine savanna burned every two years. An active nest was located in the grass in the foreground of the photo. Bullock County, Alabama. [(CC BY-NC 4.0)](<https://creativecommons.org/licenses/by-nc/4.0/>)
...
Reviews [19,43,62] and an investigation of the Bachman sparrow's diet in eastern Texas [1] summarize the species that comprise the Bachman's sparrow's diet. A variety of grass seeds such as panicgrasses, bristlegrasses (_Setaria_ spp.), crowngrasses (_Paspalum_ spp.), and threeawns are eaten by Bachman's sparrows as well as seeds of several other taxa, including blueberries (_Vaccinium_ spp), pines, and sedges (_Carex_ spp). Arthropods in the Bachman's sparrow's diet include grasshoppers and crickets (_Orthoptera_ spp.), spiders (Araneae), beetles (_Coleoptera_ spp.), caterpillars (_Lepidoptera_ spp.), wasps (Hymenoptera), and leafhoppers (Cicadellidae) [1,19,43,62]. According to reviews, insects comprise more of the Bachman's sparrow diet in spring and fall than in winter [19,43,62]. Stomach contents of Bachman's sparrow collected in eastern Texas in summer (n=5) and fall (n=11) had a greater abundance of insects than those collected in winter (n=4) [1].
...
Photo by Christoph Morning, iNaturalist.org, some rights reserved. 

Bachman's sparrow perched on a burned pine above a palmetto (_Sabal_ or _Serenoa_ spp.) understory, Osceola County, Florida. [(CC BY 4.0)](<https://creativecommons.org/licenses/by/4.0/>)
...
Season| Plots| Average number of Bachman's sparrows 
---|---|--- 
Dormant| 1| 1.25 
2| 3.52 
3| 2.0 
...
Reviews of fire ecology in southeastern pine savannas are provided by [23,51], while Van Lear and others [68] review fire ecology and restoration requirements of the longleaf pine-grassland ecosystem.

The following table provides fire return intervals for plant communities and ecosystems where Bachman's sparrow may occur. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type.

Community or ecosystem| Dominant species| Fire return interval range (years) 
---|---|--- 
Cedar glades| _Juniperus virginiana_| 3-22 [29,49] 
Slash pine| _Pinus elliottii_| 3-8 
Sand pine| _Pinus elliottii_ var _. elliottii_| 25-45 [69] 
South Florida slash pine| _Pinus elliottii_ var. _densa_| 1-15 [46,61,69] 
Longleaf-slash pine| _Pinus palustris-P. elliottii_| 1-4 [46,69] 
...
Southeastern oak-pine| _Quercus-Pinus_ spp.| <10 [69] 
Cabbage palmetto-slash pine| _Sabal palmetto-Pinus elliottii_| <10 [46,69] 
...
Photo by Eli Wess, US Fish and Wildlife Service, no rights reserved. 

Smoke from a prescribed fire in a shortleaf pine-loblolly pine savanna at Felsenthal National Wildlife Refuge, where Bachman's sparrow is known to occur. Union County, Arkansas. (CC0 1.0)
...
Given the likely importance of landscape factors on Bachman's sparrows, planning burns spatially to minimize dispersal distances or provide dispersal corridors is likely to minimize the impacts of burning on Bachman's sparrow [57]

Fire's effect on food sources (Diet) [6,15,40] and nest parasites (Predators) [10] should also be considered when considering the impact of fire in potential or occupied Bachman's sparrow habitat.
