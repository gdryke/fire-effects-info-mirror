...
Fryer, Janet L. 2011. _Alnus incana_ , thinleaf alder. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/alninc
...
Photo © Daniel Spada, iNaturalist.org, some rights reserved. 

Thinleaf alder at Lassen Volcanic National Park in June ([CC BY-NC](<https://creativecommons.org/licenses/by-nc/4.0/>)).

The scientific name of gray alder is _Alnus incana_ (L.) Moench (Betulaceae) [120,127,137,167,169,192,237]. There are 2 subspecies in North America:

 * _Alnus incana_ (L.) Moench subsp._rugosa_(Du Roi) R.T. Clausen, specked alder [120,137,192,205,237,255]
 * _Alnus incana_ (L.) Moench subsp. _tenuifolia_ (Nutt.) Breitung, thinleaf alder [120,167,179,192,355]

European gray alder, _Alnus incana_ (L.) Moench subsp._incana_ , is native to western Europe [120,127]. It has been introduced in the northeastern United States [231]. Since variation in the subspecies is continuous rather than discrete, gray alder subspecies are sometimes difficult to tell apart ([127], review by [143]). Speckled alder and thinleaf alder intergrade where their ranges overlap, mostly in Saskatchewan and Manitoba [106,120,127,231].

In this review, gray alder refers to information that is general to the species. Speckled alder refers to _A. i._ subsp. _rugosa_ , and thinleaf alder refers to _A. i._ subsp. _tenuifolia._

### Hybrids

Gray alder hybridizes with European alder (_A. glutinosa_), an introduced species [133]. Speckled alder hybridizes and intergrades with hazel alder (_A. serrulata_) [120,231,295]. Speckled alder × hazel alder hybrid swarms may occur in Massachusetts and elsewhere [127]. Thinleaf alder may hybridize with red alder (_A. rubra_) in Idaho [202].

### Synonyms

For speckled alder (_Alnus incana_ subsp._rugosa_):

 * _Alnus incana_ (L.) Moench var. _americana_ Regel [131]
 * _Alnus rugosa_ (Du Roi) Spreng. [106,171,231,295,304,350,359]
 * _Alnus rugosa_ (Du Roi) Spreng. var. _americana_ (Regel) Fernald [37,304]
 * _Alnus rugosa_ (Du Roi) Spreng. var. _rugosa_
 * _Alnus rugosa_ (Du Roi) Spreng. forma _hypomalaca_ Fern [37,304]

For thinleaf alder (_Alnus incana_ subsp. _tenuifolia_):

 * _Alnus incana_ (L.) Moench var. _occidentalis_ (Dippel) C.L. Hitchc. [208,304]
 * _Alnus incana_ (L.) Moench var. _virescens_ S. Watson
 * _Alnus_ × _purpusii_ Callier
 * _Alnus tenuifolia_ Nutt. [155,208,231,242]

### Other Common Names

gray alder, speckled alder, tag alder, mountain alder
...
Photo courtesy of USDA, NRCS. 2026. The PLANTS Database [29 Jan 2026]. 
...
Distribution of thinleaf alder in the United States and Canada.
 ...
 * Canada: AB, BC, LB, MB, NB, NF, NS, NT, ON, PE, QC, SK, YT [335]
...
Speckled alder silhouette on Whitefish Island, Sault Ste. Marie, Ontario, Canada ([CC BY-NC](<https://creativecommons.org/licenses/by-nc/3.0/us/>)).
 ...
 * **Great Lakes, general**
 * Black spruce-tamarack /speckled alder forest cover type; a minor type [134]
 * **Michigan**
 * Black spruce/speckled alder/Sphagnum spp., northern white-cedar/speckled alder, and tamarack/speckled alder vegetation types of Isle Royal National Park; occur on peats, mucks, or wetland depressions. Speckled alder swamps occur on seasonally flooded sites [330].
 * Speckled alder-willow high bog association in Cheboygan County; forms a transitional zone between quaking aspen (Populus tremuloides) and northern white-cedar associations [110]
 * The high bog shrub association of northern Lower Michigan. Speckled alder dominates marshy areas within this type; tamarack may invade after fire [129].
 * **Minnesota**
 * Speckled alder mire and black spruce/speckled alder forest communities of Voyageurs National Park [207]
 * Thinleaf alder/shoreline sedge (Carex hyalinolepis) and thinleaf alder/beaked sedge (C. rostrata) marginal fens of east-central Minnesota; these fens are surrounded by tamarack forests [73]
 * **Wisconsin**
 * Speckled alder/white panicle aster-spotted sandmat (Symphyotrichum lanceolatum-Chamaesyce maculata) thickets
 * Dominant in the understories of tamarack, black spruce, balsam fir, and mixed-conifer forested wetlands [85]

**_Northeast_**

 * **Eastern North America, general**
 * Speckled alder marginal bogs at maple-American elm (Acer spp.-Ulmus americana) transitional zones [89]
 * Speckled alder palustrine, broadleaved deciduous dominance types 
speckled alder scrub-shrub fresh wetlands [80]
 * Balsam fir/speckled alder forest cover types [124]
 * **Maine**
 * Acadia National Park:
 * Red maple/speckled alder-winterberry/royal fern (Ilex verticillata/Osmunda regalis) swamp woodland association
 * Speckled alder-red-osier dogwood/devil's darning needles (Cornus sericea/Clematis virginiana) alluvial thicket association (typically on fens)
 * Speckled alder-catberry/sphagnum (Ilex mucronata/Sphagnum spp.) northern peatland shrub swamp association
 * Typical dominant in the short shrub layer of red spruce-white spruce forests [233]
 * **New York**
 * Rich speckled alder fens; the fens are typically strongly minerotrophic on a woody peat substrate
 * Speckled alder shrub swamps of northern New York [293]
 * **New England**
 * Speckled alder wetlands and swamp shrublands of Delaware Water Gap National Recreation Area, New Jersey and Pennsylvania [282,283]
 * Hazel alder/speckled alder/arrow arum-bluejoint reedgrass (Peltandra virginica-Calamagrostis canadensis) swamps in Appomattox Court House National Historical Park [277], Fredericksburg and Spotsylvania National Military Park [327], Petersburg National Battlefield [278], and Richmond National Battlefield [279], Virginia

** _Southern Appalachians_**

 * West Virginia
 * Speckled alder-American black elderberry (Sambucus nigra subsp. canadensis ) communities on levees or floodplains where the water table is 1 to 30 inches (2.5-76 cm) below the surface and speckled alder-withe-rod (Viburnum nudum var. cassinoides) communities where the water table is 2 to 7 inches (5-18 cm) below the surface [90]
 * High-elevation (~3,200 feet (980 m)) mixed conifer-hardwood/speckled alder forest wetland, speckled alder shrub wetland [122], and floodplain speckled alder tall shrub thicket [123] vegetation types

** _Southeast_**

 * **Georgia**
 * Wax myrtle (Myrica cerifera)-speckled alder river swamps of the St Mary's River in the Okefenokee Swamp and speckled alder-Virginia sweetspire (Itea virginica) branch swamps that form off of tributaries of the St Mary's River [361]

**_Canada_**

 * **Boreal North America, general**
 * Black spruce/speckled alder willow forest cover types; occur from Saskatchewan to Newfoundland on sites where the water table is at or above the soil surface during the growing season [86]
 * Tamarack/speckled alder forest cover types [187]
 * **Saskatchewan**
 * Pussy willow (Salix discolor)-speckled alder/meadow horsetail (Equisetum pratense) community types on the Saskatchewan River Delta [97]
 * **Ontario**
 * Tamarack/speckled alder/bunchberry (Cornus canadensis) vegetation types south of James Bay [56]
 * Speckled alder/sensitive fern/Canadian mint (Onoclea sensibilis/Mentha canadensis) shoreline and bog-edge, black spruce-tamarack/speckled alder, white spruce-balsam fir/American mountain-ash (Sorbus americana)/speckled alder/bunchberry, jack pine-quaking aspen-paper birch/speckled alder-resin birch (Betula glandulosa), quaking aspen/willow-speckled alder, and eastern cottonwood (Populus deltoides)/speckled alder associations of St Lawrence Valley [88]
 * Speckled alder/Magellan's sphagnum-three-leaved Solomon's seal-naked miterwort (Sphagnum magellanicum-Smilacina trifolia-Mitella nuda) communities on deep (≥20 inches (40 cm)) organic soils [188]
 * Hardwood-speckled alder forest cover types; balsam poplar (Populus balsamifera) and quaking aspen usually dominate the overstory
 * Conifer-speckled alder forest cover types; black spruce and occasional northern white-cedar dominate the overstory [189]
 * **Quebec**
 * Jack pine/speckled alder/Schreber's moss (Pleurozium schreberi) forest cover type [238]
 * Quaking aspen/speckled alder forest cover type on alluvial or other depositional soils [116]
 * Speckled alder community type on late-glacial fluvial deposits [251]
 * **Maritime provinces**
 * Black spruce-tamarack /speckled alder forest cover type [134]
 * **Newfoundland**
 * Speckled alder swamp thickets with a ground layer of stiff clubmoss (Lycopodium annotinum) and/or shining clubmoss (L. lucidulum); these thickets succeed to balsam fir and/or white spruce without disturbance 
speckled alder-conifer swamps with white spruce and/or balsam fir in the subcanopy and wood horsetail (E. sylvaticum), small enchanter's nightshade (Circaea alpina) or other herbs in the ground layer; these communities are relatively unproductive as timber sites [250]
 * Black spruce/speckled alder and balsam fir/speckled alder forest types
 * Black spruce/speckled alder swamps [86]
...
Photo © Austin Saunders, iNaturalist.org, some rights reserved. 

Thinleaf alder growing along Three Bar Trail, Livermore, Colorado, in February ([CC BY-NC](<https://creativecommons.org/licenses/by-nc/4.0/>)).
...
Thinleaf alder in a mixed-conifer forest on the El Dorado National Forest, California.
 ...
 * Black spruce/thinleaf alder willow forest cover types; occur from Alaska to Saskatchewan on sites where the water table is at or above the soil surface during the growing season [86]

**West, general**

 * Thinleaf alder scrub-shrub fresh wetlands [80]

**Alaska**

 * Thinleaf alder and willow-thinleaf alder thickets; occur on floodplains, streambanks, and swamplands throughout Alaska except in the Aleutian Islands and the arctic coastal plains
 * Balsam poplar/thinleaf alder vegetation types; these occur mostly in interior, southwestern, and south-central Alaska, with isolated occurrences in the Brooks Range
 * White spruce/thinleaf alder and black spruce/thinleaf alder vegetation types. These types occur throughout central and southern Alaska; white spruce/thinleaf alder/bluejoint reedgrass types occur up to the northern and elevational tree lines [343].
 * Balsam poplar/thinleaf alder/field horsetail vegetation types along the Alaskan Highway; occur on sands and gravels [271]
 * Successional thinleaf alder/balsam poplar stands on floodplains of the Tanana River [1]
 * Thinleaf alder rangeland types from central to southern Alaska [218]
 * Tall shrub swamp rangeland types in interior and southeastern Alaska [249]
 * Feltleaf willow-Sitka willow (Salix sitchensis)-thinleaf alder successional communities above Glacier Bay [76]

**_Pacific Northwest_**

**Pacific Northwest, general**

 * Eastside midmontane thinleaf alder-willow (Salix spp.) riparian-shrubland habitat types of Washington and Oregon
 * Black cottonwood/thinleaf alder eastside riparian woodlands [82]
 * Thinleaf alder snowslide communities of the Blue Mountains; occur from 4,000 to 6,000 feet (1,000-2,000 m) elevation on slopes ≥40° [144]
 * Sometimes codominant in montane mixed-coniferous wetland forests of the Cascade and Klamath mountains [65]

**Oregon**

 * Thinleaf alder/skunk cabbage (Lysichitum americanum) riparian plant communities of northwestern Oregon; these are on moist to continuously saturated depressions and seepage slopes [245]
 * Thinleaf alder/Kentucky bluegrass, black cottonwood/thinleaf alder, and ponderosa pine/thinleaf alder/Kentucky bluegrass community types along Catherine Creek, northwestern Oregon [194]
 * Quaking aspen/thinleaf alder communities of the Blue Mountains [325]
 * Thinleaf alder/Wood's rose, thinleaf alder/Kentucky bluegrass, and thinleaf alder/woolly sedge (Carex pellita) community types of the Trout Creek Mountains [114]
 * Quaking aspen/thinleaf alder-red-osier dogwood and quaking aspen/thinleaf alder-common snowberry plant communities of the Blue Mountains [325]
 * Thinleaf alder community type of central Oregon; found from 2,400 to 5,600 feet (270-1,700 m) elevation. This is a young, seral type that typically occurs between active stream channels and floodplains of 2nd-order and larger streams. Sometimes it occurs in quiet backwaters [200].
 * Thinleaf alder-common snowberry association on well-developed, active fluvial surfaces, thinleaf alder/queencup beadlily (Clintonia uniflora) streambank association, panicled bulrush-bigleaf sedge-thinleaf alder (Scirpus microcarpus-Carex amplifolia) association on active channel shelves; these occur in central Oregon [201]
 * Thinleaf alder spring and seep communities; occur throughout central Oregon but occupy little total acreage. This community type is usually wet year-round and rarely burns.
 * Thinleaf alder-common snowberry community type; most common in the Ochoco Mountains. Found on floodplains of 2nd-order and larger streams.
 * Thinleaf alder-Douglas spirea (Spiraea douglasii) community type of the Deschutes and Fremont-Winema National Forests. Occur from 2,200 to 5, 700 feet (730-1,700 m) on steep to moderate-gradient floodplains.
 * Black cottonwood/mountain alder/woolly sedge community type on the Fremont National Forest; successional to lodgepole pine/water sedge (Carex aquatilis)
 * Black cottonwood-Engelmann spruce/mountain alder-red-osier dogwood community type on the Winema National Forest [200]
 * Thinleaf alder/scouringrush horsetail (E. hyemale) community types on river channel banks and floodplains of the Upper Klamath Basin. Flood-return intervals were ≤3.1 years, while flood-return intervals for willow and other shrub types were generally >25 years [63].

**Washington**

 * Black cottonwood-thinleaf alder and black cottonwood/thinleaf alder-red-osier dogwood plant associations; major types in eastern Washington
 * Western redcedar/thinleaf alder plant association; a minor type in eastern Washington
 * Thinleaf alder series of eastern Washington. The series includes these plant associations:
 * Thinleaf alder-red-osier dogwood-common snowberry and thinleaf alder-common snowberry
 * Thinleaf alder-Douglas spirea
 * Thinleaf alder alluvial bar
 * Thinleaf alder/lady fern (Athyrium filix-femina)
 * Thinleaf alder/bluejoint reedgrass
 * Thinleaf alder/Northwest Territory sedge (C. utriculata)
 * Thinleaf alder/horsetail (Equisetum spp.)
 * Thinleaf alder/tall mannagrass (Glyceria elata)
 * Thinleaf alder/oak fern (Gymnocarpium dryopteris)
 * Thinleaf alder/skunk cabbage
 * Thinleaf alder/mesic forb
 * Thinleaf alder/firethread sedge (C. scopulorum var. prionophylla)
 * Tthinleaf alder/reed canarygrass (Phalaris arundinacea)
 * Thinleaf alder/panicled bulrush (Scirpus microcarpus) [202]

**California**

 * Sometimes codominant in streamside or meadowside California red fir/Sierra laurel (Abies magnifica/Leucothoe davisiae) forest types of the Klamath Mountains [299]
 * White fir-mixed conifer/thinleaf alder riparian, spring, and seep plant associations of the northern Sierra Nevada and the Southern Cascade Range [118]
 * Sometimes dominates riparian woodland rangeland types from 5,000 to 8,000 feet (1,500-2,400 m) in the Sierra Nevada [244]
 * Thinleaf alder-western azalea (Rhododendron occidentale)/fowl mannagrass riparian community types of the western Sierra Nevada [156]

**_Southwest_**

**Southwest, general**

 * Thinleaf alder riparian forest habitat types of the Southwest [220]
 * High-elevation (6,969-8,241 feet (2,124-2,512 m)) thinleaf alder community types of Arizona and New Mexico; some willows present but cover is ≥80% thinleaf alder
 * Thinleaf alder-mixed-deciduous community types of Arizona and northern New Mexico; white fir, narrowleaf cottonwood and/or quaking aspen codominate [326]

**Arizona**

 * Montane willow-thinleaf alder and mixed-deciduous thinleaf alder-willow and thinleaf alder riparian community type series of Arizona [96,276]

**New Mexico**

 * Montane willow-thinleaf alder and mixed-deciduous thinleaf alder-willow and thinleaf alder riparian series [96,276]
 * Thinleaf alder-red-osier dogwood, thinleaf alder-bluestem willow, thinleaf alder-Pacific willow (Salix lucida subsp. lasiandra), and thinleaf alder/bluejoint reedgrass temporarily flooded shrubland community types
 * Blue spruce/thinleaf alder-Wood's rose and boxelder (Acer negundo)/thinleaf alder forested wetland community types [262]
 * Indicator and/or codominant taxon in riparian blue spruce vegetation type series
 * Bebb's willow-thinleaf alder and boxelder/thinleaf alder vegetation type series [95]
 * Narrowleaf cottonwood/thinleaf alder-red-osier dogwood community type [262]
 * Community types of the Upper and Middle Rio Grande watersheds:
 * Blue spruce/thinleaf alder
 * Narrowleaf cottonwood/thinleaf alder
 * Thinleaf alder-bluestem willow (Salix irrorata) [109]

**_Great Basin_**

**Nevada**

 * Thinleaf alder-red-osier dogwood, thinleaf alder/mesic forb, thinleaf alder/mesic graminoid, and quaking aspen/thinleaf alder-willow (Salix spp.) temporarily flooded shrubland alliances; these have G3 rankings (vulnerable) [264,284]
 * Thinleaf alder/willow (S. geyeriana, S. lasiandra, S. lutea, and/or S. scouleriana) community types of western and northeastern Nevada. Ranges from 5,650 to 7,840 feet (1,720-2,390 m) elevation; surrounding communities include quaking aspen, subalpine fir, western white pine (Pinus monticola), lodgepole pine, and mountain big sagebrush [239]
 * Thinleaf alder-Wood's rose, thinleaf alder/Kentucky bluegrass, and thinleaf alder/woolly sedge community types of the Trout Creek Mountains. The thinleaf alder/woolly sedge community was found only where livestock grazing was excluded and may be successional to the thinleaf alder/Kentucky bluegrass type [114].
 * Thinleaf alder/thinleaf alder community type of the eastern Sierra Nevada and northeastern Nevada; occurs in montane valleys
 * Thinleaf alder/mesic forb community type of the eastern Sierra Nevada and northeastern Nevada. Thinleaf alder growth is sparser than is typical of most thinleaf alder communities. Columbian monkshood (Aconitum columbianum) and tall fringed bluebells (Mertensia ciliata) are representative forbs [239].

**Utah**

 * Thinleaf alder/red-osier dogwood, riparian community types of 2nd- to 4th-order streams, and thinleaf alder/field horsetail stream and meadow community types
 * Thinleaf alder/mesic forb riparian community types of the Uinta and Wasatch mountains and the Canyonlands area. Cow parsnip (Heracleum lanatum) and Columbian monkshood are characteristic dominant forbs.
 * Thinleaf alder/mesic graminoid community types of the Uinta and Abajo mountains and the Canyonlands area. Kentucky bluegrass and tickle grass (Agrostis scabra) are characteristic dominant forbs [274].
 * Thinleaf alder-willow (Salix spp.) streamside communities of upper Big Cottonwood Canyon (8,000-9,000 feet (2,400-2,700 m)) in the Wasatch Mountains. Scouler willow is typically codominant. [3].

**_Northern and Central Rockies_**

**Rocky Mountains, general**

 * Thinleaf alder-water birch mountain riparian shrub plant associations by narrow, slow-moving streams of Idaho, Wyoming, and Colorado
 * Thinleaf alder-Drummond willow (Salix drummondiana)/field horsetail plant associations on seasonally flooded streambanks
 * Rocky Mountain maple (Acer glabrum)-thinleaf alder mountain riparian shrub plant associations
 * Blue spruce/thinleaf alder riparian plant associations of Wyoming, Colorado, and New Mexico (review by [185])
 * Subalpine fir-Engelmann spruce/thinleaf alder riparian forest association [284]
 * Narrowleaf cottonwood/thinleaf alder-red-osier dogwood plant associations on flat streambeds and floodplains of Wyoming and Colorado (review by [185])
 * Quaking aspen/thinleaf alder temporarily flooded association [284]
 * Thinleaf alder/red-osier dogwood, thinleaf alder/mesic forb, and thinleaf alder/mesic graminoid shrubland associations [284]

**Idaho**

 * Characteristic or dominant taxon of rich limestone fens in northern Idaho [61]
 * Thinleaf alder plant community of northern Idaho. This may be a minor type and was not well sampled as of 1991 [74]
 * Thinleaf alder community types in valleys, foothills, and mountains of eastern Idaho. This is a major type from 5,200 to 6,930 feet (1,580-2,110 m) elevation on streambanks, floodplains, seeps, and canyon bottoms [150].
 * Thinleaf alder-red-osier dogwood community type of the Upper and Middle Fork Salmon River; most common on gravel- and sandbars [333]
 * Thinleaf alder-northern black currant (Ribes hudsonianum) community type of central Idaho; these occur as narrow stringer communities near perennial streams. They are successionally stable and may completely shade the streams [365].
 * Thinleaf alder-red-osier dogwood riparian communities of southwestern Idaho; sagebrush (Artemisia spp.) or conifer communities are adjacent [260]

**Montana**

 * Wetland and riparian indicator plant [151]
 * Thinleaf alder riparian habitat types at low to midelevations (3,760-6,700 feet (1,150-2,040 m)); occupy alluvial terraces, streambanks, and floodplains of moderate- to high-gradient streams. Typically, thinleaf alder is dense and plant species diversity is high [151]. In thinleaf alder dominance types on midelevation alluvial terraces, the herbaceous understory is typically sparse; field horsetail and sedges (Carex spp.) are characteristic [149].
 * Dominant shrub in spruce (Picea spp.)/skunk cabbage and quaking aspen/bluejoint reedgrass riparian habitat types [151]
 * Characteristic or dominant on rich limestone fens of northwestern Montana [61]
 * Engelmann spruce/thinleaf alder-Wood's rose/field horsetail, Engelmann spruce/thinleaf alder/bluejoint reedgrass, thinleaf alder-red-osier dogwood/meadow horsetail-field mint (Mentha arvensis), and Drummond willow-thinleaf alder riparian community types of northwestern Montana [32]
 * Thinleaf alder community types of central and eastern Montana. These are minor types at low to midelevations (4,720-6,400 feet (1,580-1,950 m)) along moderate to high-gradient streams. Bluejoint reedgrass and nonnative fowl bluegrass (Poa palustris) are typically dominant in the ground layer [151,302]. These are temporarily flooded communities, ranked G3 (vulnerable) [302]
 * Thinleaf alder wetland community type of west-central Montana; associated with year-round seeps and valley springs and characterized by high plant species diversity. Subalpine fir or Douglas-fir communities are adjacent [286].
 * Thinleaf alder community type in southwestern Montana; a minor type typically confined to moist stream edges, overflow channels, and hillside seeps. A disturbance type that may persist for "a long time" before willows or conifers replace thinleaf alder successionally [151].

**Wyoming**

 * Engelmann spruce-subalpine fir/thinleaf alder, blue spruce/thinleaf alder, blue spruce-lodgepole pine-white fir/rose (Rosa spp.)-thinleaf alder/western wheatgrass (Pascopyrum smithii), ponderosa pine/thinleaf alder, and thinleaf alder/western snowberry riparian habitat types [269]
 * Thinleaf alder riparian type of the Medicine Bow National Forest. This type is associated with subalpine fir/grouse whortleberry (Vaccinium scoparium) habitat types of the Sierra Madre and Laramie Peaks [2]. It may form extensive stands in moist areas.
 * Thinleaf alder-northern black currant community type of west-central Wyoming; these occur as narrow stringer communities near perennial streams. They are successionally stable and may completely shade the streams [365].
 * Thinleaf alder/field horsetail community type of the Shoshone National Forest; water table is at the soil surface
 * Thinleaf alder/mesic graminoid community type of the Shoshone National Forest; bluejoint reedgrass and beaked sedge (C. rostrata) typically dominate the understory. Stands vary from open to dense. This type may be a thinleaf alder/forb type degraded by overgrazing [352].

**Colorado**

 * Narrowleaf cottonwood/thinleaf alder, narrowleaf cottonwood-blue spruce/thinleaf alder, and blue spruce/thinleaf alder riparian forest associations of western Colorado [15]
 * Thinleaf alder-water birch-willow (Salix spp.) riparian shrublands of the Front Range; these typically occur on the hydric limits of wet subalpine fir-Engelmann spruce forests and narrowleaf cottonwood or plains cottonwood (Populus deltoides subsp. monilifera) woodlands. On drier sites, thinleaf alder sometimes dominates the understories of subalpine fir-Engelmann spruce ravine forests [280].
 * Thinleaf alder-water birch/beaked hazelnut canyon forest association of the Front Range [342]
 * Thinleaf alder-resin birch/water sedge subalpine riparian shrub plant associations along pond margins and in spruce (Picea spp.) forest openings in Rocky Mountain National Park (review by [185])
 * Narrowleaf cottonwood/thinleaf alder riparian habitat types of the Roosevelt and Arapaho National Forests. Occurs on benches by small streams and on the floodplains of large streams [166].
 * Thinleaf alder-water birch-willow/field horsetail habitat type; common riparian type in the Middle Rocky Mountains east of the continental divide [354]
 * Thinleaf alder/field horsetail and thinleaf alder/red-osier dogwood habitat types on the Gunnison and Uncompahgre National Forests [198]. Upland thinleaf alder-red-osier dogwood plant habitat types occur on relatively dry sites on the Gunnison National Forest (review by [185]).
 * Narrowleaf cottonwood/thinleaf alder riparian community types along the Animas River [351] and in the Gunnison Basin [199]

**Utah (see entries in Great Basin)**

**_Northern Great Plains_**

**Great Plains, general**

 * thinleaf alder shrub swamps of Iowa, Minnesota, North Dakota, and Manitoba [302]

**_Canada_**

**Yukon**

 * balsam poplar-thinleaf alder vegetation types along the Dempster Highway and the Foothills Gas Pipeline; occur on riverine floodplains and terraces without permafrost [316]

**Saskatchewan**

 * Bebb willow-pussy willow-thinleaf alder vegetation types along the Peace-Athabasca Delta; common on levees that seldom flood [98]
...
Photo by Anneleen Kool, iNaturalist.org, no rights reserved. 

Thinleaf alder female catkins.
...
Male and female catkins of a speckled alder during winter ([CC BY-NC](<https://creativecommons.org/licenses/by-nc/3.0/us/>)).
...
Timing of phenological events for speckled alder by location.Location| Event| Timing 
---|---|--- 
...
Timing of phenological events for thinleaf alder by location.Location| Event| Season 
---|---|--- 
...
Thinleaf alder male catkins.

### Pollination and Breeding System

Gray alder is monoecious [171,318]. The flowers are wind-pollinated [81,261], so most plants are cross-pollinated. However, thinleaf alder self-pollinates rarely (review by [154]).
...
Gray alder first produces seed at 25 years or younger. There are usually 1 to 4 years between large seed crops (review by [154]). Thinleaf alder produces "abundant" seed (reviews by [143,256]). Mean annual seed rain of thinleaf alder in white spruce stands of interior Alaska was 745 seeds/m² [366].
...
Photo © semiferalhiker, iNaturalist.org, some rights reserved. 
...
Speckled alder twig ([CC BY-NC](<https://creativecommons.org/licenses/by-nc/3.0/us/>)).
...
A prescribed April fire top-killed most speckled alders in a study site on the Allegheny River floodplain of Pennsylvania. Open areas with individual trees burned well, but dense stands of speckled alder carried fire mostly on the edges. The fire top-killed 55% of speckled alder stems. By postfire month 9, most burned speckled alders were sprouting at or within 2 inches (5 cm) of the soil surface, from near the bottoms of the stems or from the root crowns. However, sprouting in speckled alder was not related to fire; it occurred on burned and unburned stems at approximately the same rate, 90%. Sampled stems produced an average of 8 to 10 sprouts, with basal diameters ranging from 0.1 to 0.5 inch (3-12 mm) and heights ranging from 9 to 47 inches (22-120 cm). Twelve percent of speckled alder stems were browsed, probably by white-tailed deer and cottontails [49]. See the FEIS Research Project Summary of this paper for information on the burning conditions and effects of the fire on hawthorns (Crataegus sp.) in the same area.
...
For each topographic position, mean relative density of thinleaf alder and percent of burned thinleaf alders that sprouted along Third and Fourth Water creeks in postfire year 1 [197].Site| Gravelbar| 1st terrace| 2nd terrace| Riparian-zone slope 
---|---|---|---|--- 
% of total| % sprouting| % of total| % sprouting| % of total| % sprouting| % of total| % sprouting 
Third Water Creek 
 _n_ =47 plants| 100| 100| 48| 30| 38| 54| 34| 67 
Fourth Water Creek 
 _n_ =25 plants| 23| 100| 40| 90| not present| not present| 4| 0 
...
Speckled alder biomass (lbs/acre) by forest type in Michigan [273] and the Northern Great Lakes [313].Forest type| Michigan| Northern Great Lakes 
---|---|--- 
...
Distribution of biomass (kg/ha) in thinleaf alder-dominated stands of different ages [339].Stand age| 5 years| 15 years| 20 years 
---|---|---|--- 
...
*Above- and belowground biomass were measured for live plants. 
...
Fire-return intervals of riparian and upland mixed-conifer sites in the Klamath Mountains [310].Site| Mean fire-return interval (range)| Time period| Number of stumps sampled 
---|---|---|--- 
Root Creek - riparian| 33 years (7-56)| 1673-1880| 4 
Root Creek - upland| 7 years (3-44)| 1749-1924| 14 
North Fork Shotgun Creek - riparian| 16 years (5-56)| 1710-1916| 9 
North Fork Shotgun Creek - upland| 8 years (4-64)| 1622-1887| 16 
...
Gray alder's palatability is rated poor to fair for big game animals. Sprouts and young plants are preferred over older browse ([334], review by [141]). Its palatability for livestock is rated from poor in the Southwest to fair in the Pacific Northwest and California. Gray alder is generally more palatable to cattle than to domestic sheep and goats [334].
...
Thinleaf alder provides cover for snowshoe hares [353] and big game animals [261]. Mule deer, white-tailed deer, and elk use thinleaf alder communities for thermal and hiding cover [151]. American beavers use thinleaf alder to make their dens (review by [160].
...
See these sources: [154,160] for propagation information.

**Thinleaf Alder**

Thinleaf alder is used in revegetation projects [62,256]. It is recommended for riparian revegetation in the Intermountain West [59] and the Northern and Southern Rocky Mountains [58]. It is particularly recommended for high-gradient, high-velocity, low- to midorder streams [59]. See these sources: [104,154,183,256,309] for propagation information.
...
## Table A2: Fire Regime Table for thinleaf alder

Table A2—Fire regime information on vegetation communities in which **thinleaf alder** may occur. This information is taken from the LANDFIRE Rapid Assessment Vegetation Models [214], which were developed by local experts using available literature, local data, and/or expert opinion. This table summarizes fire regime characteristics for each plant community listed. Dashes indicate that information was not available in the Rapid Assessment Vegetation Model.Vegetation Community 
(Potential Natural Vegetation Group)| Fire severity*| Percent of fires| Mean fire interval 
(years)| Minimum fire interval 
(years)| Maximum fire interval 
(years) 
...
187\. Johnston, William F. 1980. Tamarack. In: Eyre, F. H., ed. Forest cover types of the United States and Canada. Washington, DC: Society of American Foresters: 15-16. [49857]
...
305\. Scott, James A. 1986. The butterflies of North America: A natural history and field guide. Stanford, CA: Stanford University Press. 584 p. [82601]
