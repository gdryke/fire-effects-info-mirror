---
layout: default
title: Euonymus alatus — burningbush
abbreviation: EUOALA
common_name: burningbush
scientific_name: Euonymus alatus
parent: Species Reviews
grand_parent: FEIS
nav_order: 1
nav_exclude: True
written_date: February, 2009
...
Fryer, Janet L. 2009. _Euonymus alatus_ , burningbush. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/euoala
...
Photo by Lisa Hutchings, iNaturalist.org, some rights reserved. 

Burningbush growing in Essex County, Massachusetts ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>)).
 ...
 * _Euonymus alatus_ (Thunb.) Sieb. var. _alatus_
 * _Euonymus alatus_ (Thunb.) Sieb. var. _apterus_ Regel

### Synonyms

 * _Euonymus alata_ (Thub.) Sieb. [34,49]
...
Based on limited studies, burningbush may form shrublands or dense forest understories; it is uncertain whether this pattern is typical on burningbush-invaded sites. Burningbush has formed dense thickets in Pennsylvania [33]. In New York, burningbush was most common in the tall shrub layer of a yellow-poplar-red oak-American beech (_Liriodendron tulipifera_ -_Quercus rubra_ -_Fagus grandifolia_) forest [22]:

Cover (%) of burningbush in a mixed-hardwood forest in Long Island, New York [22].**Forest layer**| Tall shrub layer (2-3.5 m)| Medium shrub layer (1-2 m)| Herb layer (0-1 m)| All layers 
---|---|---|---|--- 
...
**Surface or low:** Any fire that causes less than 25% upper layer replacement and/or removal in a vegetation-fuel class but burns 5% or more of the area [18,22].
