---
layout: default
title: "Luzula glabrata var. hitchcockii — Hitchcock's smooth woodrush"
abbreviation: LUZGLAH
common_name: "Hitchcock's smooth woodrush"
scientific_name: Luzula glabrata var. hitchcockii
...
# Luzula glabrata var. hitchcockii — Hitchcock's smooth woodrush
...
Habeck, R. J. 1992. _Luzula glabrata_ var. _hitchcockii_ , Hitchcock's smooth woodrush. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/luzglah

## Introduction

## Taxonomy

The scientific name of Hitchcock's smooth woodrush is _Luzula glabrata_ (Hoppe ex Rostk.) Desv. var. _hitchcockii_ (Hamet-Ahti) Dorn (Juncaceae) [27]. There are no infrataxa.

### Synonyms

 * _Luzula hitchcockii_ Hamet-Ahti [15]
...
Map courtesy of USDA, NRCS. 2018. The PLANTS Database [2018, October 18] [27]. 

Distribution of Hitchcock's smooth woodrush.
...
Hitchcock's smooth woodrush is found in high elevations, generally ranging from 5,700 to 8,200 feet (1,737-2,500 m), with deep, late-melting snowpacks [20]. It occupies a variety of sites from montane forests to subalpine and alpine slopes, ridges, meadows, and cirque floors [17].

**Soils:** Hitchcock's smooth woodrush is found on soils derived from granitics to noncalcareous parent materials. Surface soils tend to be very acidic (pH 4.2 to 4.8). Soil textures range from sandy loam to gravelly loam [10,21,25].

## Plant Communities

Hitchcock's smooth woodrush generally occurs with subalpine fir (_Abies lasiocarpa_) and mountain hemlock (_Tsuga mertensiana_). It also occupies 20 to 25 percent ground cover of subalpine larch (_Larix lyallii_) communities in the Pacific Northwest [3]. Associated tree species include Douglas-fir (_Pseudotsuga menziesii_), western larch (Larix occidentalis), western white pine (Pinus monticola), lodgepole pine (_P. contorta_), whitebark pine (_P. albicaulis_), and Engelmann spruce (_Picea engelmannii_). Understory associates include grouse whortleberry (_Vaccinum scoparium_), Sitka valerian (_Valeriana sitchensis_), mountain arnica (_Arnica latifolia_), and menziesia (_Menziesia ferruginea_) [1,10,21,24,25].

Publications listing Hitchcock's smooth woodrush as an indicator or dominant species in habitat types are as follows:

 * Forest habitat types of northern Idaho: a second approximation [10]
...
Seasonal records for Hitchcock's smooth woodrush are scarce. The phenological stages for spiked rush (_Luzula spicata_), however, were observed near Boulder, Colorado, and are as follows [6]:

Phenology| Date 
---|--- 
Apparent end of autumn die-back| 20 September 
Spring bud break| 30 March–15 April 
 
Herbarium specimens of Hitchcock's smooth woodrush collected in western Montana show a flowering period that ranges from June 28 to August 13 for plants at 6,000 to 7,100 feet (1,829-2,164 m). At high elevations (8,000 to 8,700 feet (2,438-2,652 m)), flowering occurs from July 15th to September 1 [26].
...
**Seed Dispersal:** Seeds of Hitchcock's smooth woodrush are primarily dispersed by the splash cup method. Heavy raindrops falling directly, or from a tree drip edge, throw seeds out from the flared lip of the open capsule. In higher elevations where heavy snowpacks restrict Hitchcock's smooth woodrush height, seed dispersal relies upon vibrations from wind or passing animals.

## Successional Status

Hitchcock's smooth woodrush is considered an indicator of cold environments where snow lies late [17]. Once Hitchcock's smooth woodrush becomes established, it often forms a heavy mat which excludes other understory plants from establishing. It was listed as a mesic site indicator within the subalpine larch habitat type in the Pacific Northwest [3].

## Fire Ecology and Management

## Immediate Fire Effects

Fire top-kills Hitchcock's smooth woodrush.
...
Following fire, Hitchcock's smooth woodrush sprouts from surviving rhizomes [5,11]. In western Montana, mean fire intervals for Hitchcock's smooth woodrush sites range from 30 to 41 years [4].

## Plant Response to Fire

Hitchcock's smooth woodrush often shows an increase in biomass following fire [11]. Following a fire in a whitebark pine community in the Bob Marshall Wilderness, Montana, Hitchcock's smooth woodrush increased by 252 pounds/acre (92 kg/ha) from postfire year 1 to postfire year 3, while the cover percent remained constant. This biomass increase was attributed to vegetative sprouting from the surviving plants [5].
...
Hitchcock's smooth woodrush sites are generally important to wildlife species inhabiting high elevations. Thirteen plant species were identified as being important grizzly bear food on a Hitchcock's smooth woodrush habitat site in northern Idaho and Montana [19]. Elk in central Idaho find Hitchcock's smooth woodrush sites to have medium forage value in both summer and fall [9]. Caribou use Hitchcock's smooth woodrush sites in northern Idaho for calving habitat during June to mid-July [28].

### Palatability and Nutritional Value

Not much information is available concerning the palatability of Hitchcock's smooth woodrush. Grizzly bears in northern Idaho, however, consume all plant parts of Hitchcock's smooth woodrush which include the flowers, leaves, roots, and stems [2].
...
Many of the sites that include Hitchcock's smooth woodrush are outside commercial timber production areas, and timber management activities are not anticipated. Therefore, management of Hitchcock's smooth woodrush is generally not part of a timber management plan. Those sites occupied largely by subalpine fir and mountain hemlock (See Appendix) are generally managed using partial thinnings, long rotations (60 to 80 years), and at times are artificially regenerated [28].
