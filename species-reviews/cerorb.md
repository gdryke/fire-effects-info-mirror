---
layout: default
title: Cercis orbiculata — California redbud
abbreviation: CERORB
common_name: California redbud
scientific_name: Cercis orbiculata
...
Hauser, A. Scott. 2006. _Cercis orbiculata_ , California redbud. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/cerorb

## Introduction

## Taxonomy

The scientific name of California redbud is _Cercis orbiculata_ Greene (Fabaceae) [38].

### Synonyms

 * _Cercis occidentalis_ Torr. ex Gray [35,40,54,55,76] 
= _Cercis orbiculate_
 * _Cercis occidentalis_ var. _orbiculata_ (Greene) Tidestrom [76] 
= _Cercis orbiculata_

### Other Common Names

western redbud, Arizona redbud, Judas tree

## Distribution

## General Distribution

California redbud occurs in Arizona, California, Nevada, and Utah [35,38,40,54,55,76]. Its occurrence in Arizona is restricted to a few scattered locations in canyons and mountains in upper desert and woodland zones. It is common in the Grand Canyon [49]. In Utah, California redbud is restricted to a few scattered locations in the southern part of the state [26]. A distributional map of California redbud is available [here](<https://research.fs.usda.gov/feis/treedistributionmaps>).
...
Photo by © Casey Flinspach, some rights reserved 

California redbud [(CC BY_NC)](<https://creativecommons.org/licenses/by-nc/4.0/>)
...
California redbud is pollinated by bumble bees and orchard mason bees [11,24,72].

### Breeding System

The flowers of California redbud are dioecious [11].

### Seed Production and Predation

California redbud produces abundant crops of legumes, but seed set is variable [11].

### Seed Dispersal

California redbud seeds are dispersed by wind, birds, and animals [11].

### Seed Banking

California redbud utilizes a seed bank [23].
...
California redbud seedlings have a "rapid" growth rate [11].
 ...
 * Tall shrub, adventitious bud/root crown [69]

## Fire Adaptations

California redbud establishes following fire by seed [50] and/or sprouting from the bole [1].
...
The following table provides fire return intervals for plant communities and ecosystems where California redbud is important. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type.
...
Jeffrey pine| Pinus jeffreyi| 46172 
...
Currently (2006) there is no literature addressing the cover value of California redbud. However, given its height [35,54,55,76] and arching canopy [68,72], it likely provides cover for a variety of mammal and bird species.
...
There is one California redbud cultivar ('common') available [71].
 ...
 * K058 Grama-tobosa shrubsteppe [46]
 ...
 * 255 California coast live oak [27]
 ...
 * 509 Transition between oak-juniper woodland and mahogany-oak association [67]
...
11\. Banner, Valerie A.; Stein, William I. 2003. Cercis L. redbud. Bonner, Franklin T., tech. coord. Woody plant seed manual. Washington, DC: U.S. Department of Agriculture, Forest Service (Producer). Available: http://www.nsl.fs.usda.gov/wpsm/Cercis.pdf [2006, August 2]. [62844]
...
72\. U.S. Department of Agriculture, Natural Resources Conservation Service. 2006. PLANTS database (2006), [Online]. Available: https://plants.usda.gov /. [34262]
