---
layout: default
title: Symphoricarpos albus — common snowberry
abbreviation: SYMALB
...
contributors: J. McWilliams - 1st Author
year: 2000
...
McWilliams, Jack. 2000. _Symphoricarpos albus_ , common snowberry. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/symalb
...
Photo by Eleanor Pate, iNaturalist, some rights reserved. 

Flowering common snowberry in Alberta, Canada ([CC BY 4.0](<https://creativecommons.org/licenses/by/4.0/>)).

## Taxonomy

The scientific name of common snowberry is _Symphoricarpos albus_ (L.) Blake (Caprifoliaceae) [58,66]. The 2 recognized varieties are [56,58,66,116]:

 * _Symphoricarpos albus_ var. _albus_
 * _Symphoricarpos albus_ var. _laevigatus_ (Fern.) Blake

### Synonyms

 * _Symphoricarpos racemosus_ Michx. [48,116]
 * _Symphoricarpos rivularis_ Suksdorf [38,56]

### Other Common Names

snowberry, white coralberry

## Distribution

## General Distribution

Common snowberry occurs from Hudson Bay to Alaska, south to California and east to North Carolina. _Symphoricarpos albus_ var. _albus_ , the Atlantic slope variety, has the same general distribution described above for common snowberry. _Symphoricarpos albus_ var. _laevigatus_ , Pacific slope variety, is found from southern Alaska south to California, Montana and Colorado [38,65].
 ...
 * United States: AK CA CO CT DE ID IL IN IA KS KY MD MA MI MN MT NE NH NJ NM NY ND OH OR PA RI SD TN UT VA VT WA WV WI WY DC
...
Photo by Bryn, iNaturalist.org, some rights reserved. 

Common snowberry growing in Alberta, Canada ([CC BY 4.0](<https://creativecommons.org/licenses/by/4.0/>)).
...
Examples of climax forest habitat types where common snowberry is a subdominant include ponderosa pine (_Pinus ponderosa_), Douglas-fir (_Pseudotsuga menziesii_), and subalpine fir (_Abies lasiocarpa_) [3]. Common snowberry is considered a mid- to late-seral subdominant with ponderosa pine on floodplains in Oregon [68]. Also in Oregon, common snowberry is considered subdominant to Douglas hawthorn (_Crataegus douglasii_) in a climax tall shrub community type [10] and dominant in a community type with Wood's rose (_Rosa woodsii_) [67].

Species commonly associated with common snowberry include oceanspray (_Holodiscus discolor_) in California's hardwood rangelands [4], ninebark (_Physocarpus malvaceus_) in Oregon [63], bearberry (_Arctostaphylos uva-ursi_) in south Dakota and eastern Wyoming [3], and Idaho fescue (_Festuca idahoensis_) in eastern Washington [14].
 ...
 * Ecology of curlleaf mountain-mahogany (_Cercocarpus ledifolius_ Nutt.) in eastern Oregon and adjacent areas [32]
...
Photo by elayc, iNaturalist.org, some rights reserved. 

Fruiting common snowberry in Grays Harbor County, Washington ([CC BY 4.0](<https://creativecommons.org/licenses/by/4.0/>)).
...
Phenology for common snowberry east of the Continental Divide in Montana and Yellowstone National Park, Wyoming, is [95]:**Phenological event**| Leaf buds burst| Leaves full grown| Flowers start| Flowers end| Fruits ripe| Seed fall starts| Leaves start to color| Leaves start to fall| Leaves fallen 
---|---|---|---|---|---|---|---|---|--- 
**Average date**| 6 May| 14 June| 4 July| 22 July| 2 September| 14 September| 28 August| 9 September| 30 September 
**Earliest**| 10 April| 17 May| 4 June| 10 June| 7 August| 16 August| 20 July| 23 July| 28 August 
**Latest**| 7 June| 10 July| 11 August| 21 August 2022| 9 October| 14 October| 25 September| 15 October| 30 October 
...
Photo by Jane Kapler Smith, USFS, Fire Sciences Laboratory. 
...
The following FEIS Research Project Summaries also provide information on prescribed fire use and postfire response of plant community species including common snowberry:
...
Common snowberry occurs in a wide variety of community/habitat types and plant associations (see Distribution) [15,31,41,42], which have various fire regimes. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type. Fire-return intervals in communities where common snowberry is most common are provided below.

Community of ecosystem| Scientific name of dominant species| Fire return interval (years) 
---|---|--- 
Pacific ponderosa pine*| _Pinus ponderosa_ var. _ponderosa_| 1-47 [19] 
Rocky Mountain ponderosa pine*| _Pinus ponderosa_ var. _scopularum_| 2-10 [19] 
Rocky Mountain Douglas-fir*| _Pseudotsuga menziesii_ var. _glauca_| 40-140 [79,107] 
Coast Douglas-fir*| _Pinus menziesii_ var. _menziesii_| 95-242 [82,91] 
...
Animal| Montana| Idaho| North Dakota| Oregon 
---|---|---|---|--- 
...
---|---|---|---|--- 
Leaves| Stem| Leaves| Stem| Leaves| Stem| Leaves 
Crude protein1| 13.1| 6.80| 10.7| 4.20| 5.60| 5.10| 5.20 
ADF2| 18.3| 39.1| 20.1| 47.8| 24.4| 48.7| 50.0 
Carbohydrate components1: ADL3| 7.50| 11.0| 8.50| —| 11.4| 17.0| 20.5 
...
1 Percentage of oven-dried weight; 2 ADF = Acid-detergent fiber; 3 ADL = Acid-detergent lignin; 4 Cell = Cellulose; 5 Calories/gram 
...
Common snowberry fruit was eaten fresh but was not favored by Native Americans in Washington and Oregon. The fruits were also dried for winter use. Common snowberry can be used on hair as soap, and the fruits and leaves mashed and applied to cuts or skin sores as a poultice and to soothe sore, runny eyes. Tea from the bark can be used as a remedy for tuberculosis and sexually transmitted diseases. A brew made from the entire plant can be used as a physic tonic. Arrowshafts and pipestems can be made from the stems [51].
