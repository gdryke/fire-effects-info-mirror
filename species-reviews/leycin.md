---
layout: default
title: Leymus cinereus — basin wildrye
abbreviation: LEYCIN
common_name: basin wildrye
scientific_name: Leymus cinereus
...
Anderson, Michelle D. 2002. _Leymus cinereus_ , basin wildrye. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). Available: https://research.fs.usda.gov/feis/species-reviews/leycin
...
Photo by wessmith, iNaturalist.org, some rights reserved. 

Basin wildrye growing in Crook County, Oregon ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>)).

## Taxonomy

The currently accepted scientific name of basin wildrye is _Leymus cinereus_ (Scribn. & Merr.) A. Love (Poaceae) [17,58,66,73,130,131].

Experiments have been conducted crossing basin wildrye with Altai wildrye (_L. angustus_) [36]. Basin wildrye forms natural hybrids with Salina wildrye (_L. salinus_) [132], beardless wildrye (_L. triticoides_) [66,132], and bottlebrush squirreltail (_Elymus elymoides_) [132].

### Synonyms

 * _Elymus cinereus_ Scribn. and Merr. [32,38,39,67,68,74,84,132]

### Other Common Names

Great Basin wildrye, giant wildrye, Great Basin lyme grass

## Distribution

## General Distribution

Basin wildrye occurs from Saskatchewan to British Columbia, south to California, northern Arizona and New Mexico, and east to South Dakota and Minnesota [32,38,39,58,66,67,73,74,84,130,131,132]. Basin wildrye is extirpated from Nebraska [73]. USDA Plants Database provides a distributional map of basin wildrye.

### [States and Provinces](<https://research.fs.usda.gov/feis/statesprovinceskey>)

 * United States: AZ CA CO ID MN MT NV NM OR SD UT WA WY
 * Canada: AB BC SK

## Site Characteristics

Basin wildrye grows on sites subject to environmental extremes: freezing and thawing as well saturated soils in spring followed by hot, desiccated soils in summer [6,27,72].

### Elevation

The general elevation range of basin wildrye is 1,970 to 9,840 feet (600-3,000 m) [27,66]. It grows at 1,000 to 2,000 feet (300-600 m) in drainage basins and up to almost 10,000 feet (3,000 m) in mountains [66,129,132]. The elevation distribution of basin wildrye is presented by state in the following table:
...
Basin wildrye generally requires at least 8 inches (200 mm) of precipitation per year [35], but may be adapted to sites receiving 5 to 20 inches (130-500 mm) [16,27,116]. A breakdown of annual average precipitation by state is found below:
...
In addition to occurring in a variety of plant community types, basin wildrye may form nearly pure stands [70,127]. On sites in Utah, it may constitute 76% cover (out of 91% total plant cover) [127].

Tree and shrub codominants occurring with basin wildrye include singleleaf pinyon (_Pinus monophylla_), Utah juniper (_Juniperus osteosperma_), green rabbitbrush (_Chrysothamnus viscidiflorus_), longflower snowberry (_Symphoricarpos longiflorus_), black greasewood (_Sarcobatus vermiculatus_), basin big sagebrush (_Artemisia tridentata_ ssp. _tridentata_), mountain big sagebrush (_A. tridentata_ ssp. _vaseyana_), Wyoming big sagebrush (_A. tridentata_ ssp. _wyomingensis_), and low sagebrush (_A. arbuscula_) [21,22,70,70,91,93,120,133].
...
Photo by Michelle Skip Vasquez, iNaturalist.org, some rights reserved. 
...
Basin wildrye growing in a shrubland community in Inyo County, California ([CC BY 4.0](<https://creativecommons.org/licenses/by/4.0/>)).
...
Basin wildrye is the largest cool-season perennial bunchgrass native to the western United States [1,5,6,27,82]. It forms large clumps, but may have short rhizomes [17,32,82]. Basin wildrye reaches basal diameters of 2 to 4 feet (0.6-1.2 m) [32,71,92] and grows up to 6.5 (2 m) tall [6,16,17,27,31,32,58,82,92,132]. Leaves grow to 0.8 inch (2 cm) wide [71,92]. The spikes (seedheads) of basin wildrye grow 4 to 11.5 inches (10-29 cm) long, with 16 to 35 nodes [17,27,32,67,132]. There are 2 to 7 spikelets per node [17,27,32,58,132], growing 0.35 to 0.75 inch (9-19 mm) long and having 3 to 7 florets each [17,32,132].

Basin wildrye has high photosynthetic capacity and high nitrogen-use efficiency [5].
...
As a cool-season grass, basin wildrye experiences early spring growth [56] and flowers in early to midsummer [84,88]. With abundant spring moisture, basin wildrye quickly advances through maturity [50]. Lower-elevation populations ripen seed in early July while seed of higher montane populations may not be ripe until late September [88]. Basin wildrye is dispersed in July and August [88], becoming dormant in late summer [5].

## Regeneration Processes

Basin wildrye reproduces by seed and vegetatively by rhizomes [92].
...
Basin wildrye is attacked by a variety of insects, potentially reducing both forage and seed production [139]. In particular, the wheat stem sawfly reduces seed weight and production but not germination rates [138].
...
Basin wildrye reproduces from tillers and short rhizomes [17,32,66,82,92]. Vegetative reproduction of basin wildrye may be more important than reproduction by seed [138], though some authors report it relies primarily on recruitment from seed for stand replacement and expansion [88].

## Successional Status

Basin wildrye is tolerant of partial shade in shrublands and woodlands [129]. It grows on both disturbed and undisturbed soils [1,6,103]. Basin wildrye occurs after disturbance, in secondary succession, and also in climax communities [4,33,127,128,140]. It may be a major component of the dominant grass and forb stage that develops shortly after fire in pinyon-juniper communities [95], and once established may dominate a site [127].
...
Photo courtesy of the National Interagency Fire Center's Image Portal. 

Igniting basin wildrye.

Basin wildrye is top-killed by fire [100,137,141].

Older basin wildrye plants with large proportions of dead material within the perennial crown can be expected to show higher mortality due to fire than younger plants having little debris [100,141]. Basin wildrye is generally tolerant of fire but may be damaged by early-season fire combined with dry soil conditions [129].

## Postfire Regeneration Strategy

 * Tussock graminoid
 * Secondary colonizer (on-site or off-site seed sources) [117]

## Fire Adaptations

The coarseness of basin wildrye foliage resists prolonged burning, allowing plants to avoid exposure of their basal growing points to sustained heating. Plants sprout from surviving root crowns and rhizomes [24]. Basin wildrye is more likely to survive and resprout following late season fire, when it is dormant, than at any other point in the growing season [100,141].

## Plant Response to Fire

Basin wildrye has high survival rates following fire due to resprouting from the surviving root crown and rhizomes [24,76,100,128,137,141]. It recovers rapidly, especially after dormant-season fires [24]. Basin wildrye is well adapted to fire, growing vigorously after burning when moisture is adequate [18,30,42,62,77,78], and increasing in percent cover [76]. Annual biomass production may increase following fire for several years [18]. Basin wildrye is stimulated to flower after burning [2,3].

Basin wildrye may respond to "fire cues" like smoke. Treatment of basin wildrye seeds with the smoke of burning big sagebrush can significantly increase (_p_ <0.10) leaf elongation rates and new leaf production compared with controls. After 83 days of growth, smoke-treated seeds produce significantly greater (_p_ <0.05) plant mass than nontreated seeds [23].

## Fire Regimes

Sagebrush, desert shrub, and grassland communities with a basin wildrye component historically experienced mostly infrequent to frequent, stand-replacing fires. Sagebrush communities experienced fire intervals of 20 to 70 years, while desert shrub community fire intervals ranged from 35 to 100 years. Grassland vegetation types experienced both short fire intervals of less than 35 years as well as intervals ranging from 35 to 100 years, depending on climate and ignition sources [96]. Forest and woodland communities with a basin wildrye component historically experienced understory or mixed-severity fire regimes with varying fire return intervals [8,96]. Fire return intervals for plant communities and ecosystems in which basin wildrye is an important component of the vegetation are summarized below. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type.

Community or Ecosystem| Dominant Species| Fire Return Interval Range (years) 
---|---|--- 
sagebrush steppe| _Artemisia tridentata/Pseudoroegneria spicata_| 20-70 [96] 
basin big sagebrush| _A. t._ var _. tridentata_| 12-43 [111] 
_A. t._ var _. vaseyana_| 15-40| [9,26,90] 
Wyoming big sagebrush| _A. t._ var _. wyomingensis_| 10-70 (40**) [123,135] 
...
blue grama-buffalo grass| _B. gracilis-Buchloe dactyloides_| <35 [96] 
curlleaf mountain-mahogany*| _Cercocarpus ledifolius_| 13-1000 [11,112] 
...
pinyon-juniper| _Pinus-Juniperus_ spp _._| <35 [96] 
Rocky Mountain lodgepole pine*| _P. contorta_ var _. latifolia_| 25-300+ [7,8,106] 
Colorado pinyon| _P. edulis_| 10-49 [96] 
interior ponderosa pine*| _P. ponderosa_ var _. scopulorum_| 2-30 [8,14,81] 
galleta-threeawn shrubsteppe| _Pleuraphis jamesii-Aristida purpurea_| <35 to <100 
eastern cottonwood| _Populus deltoides_| <35 to 200 [96] 
quaking aspen (west of the Great Plains)| _P. tremuloides_| 7-120 [8,55,87] 
...
oak-juniper woodland (Southwest)| _Quercus-Juniperus_ spp _._| <35 to <200 [96] 
*fire return interval varies widely; trends in variation are noted in the species summary**mean 
 
## Fire Management Considerations

A study conducted at Craters of the Moon National Monument in Idaho offers an example of fuels distribution in basin wildrye-dominated communities containing some big sagebrush and rubber rabbitbrush (_Chrysothamnus nauseosus_). These communities had fuel loads of 90 pounds/acre (495 kg/ha) and 210 pounds/acre (1,150 kg/ha) for Class 3 (1-3 inches or 2.5-7.5 cm) and Class 4 (>3 inches or 7.5 cm) fuels, respectively. Sites had 72% perennial grass cover with 735 pounds/acre (4,040 kg/ha) herbage production and 2,030 pounds/acre (11,160 kg/ha) litter production annually [18].

Fire may create openings in basin wildrye stands, providing an opportunity for Canada thistle (_Cirsium arvense_) to establish and spread in these communities [18].
...
Basin wildrye may resprout rapidly after fire, regardless of fire severity. In a Nevada study of a few individual plants, basin wildrye resprouted in the 1st growing season following both low- and high-severity prescribed burns [100].
...
The early growth and abundant production of basin wildrye may make it a valuable source of forage for livestock and wildlife [30]. It is important forage for cattle [41] and is readily grazed by cattle and horses in early spring and fall [56]. Though unpalatable during the winter, basin wildrye may be utilized more frequently by livestock and wildlife when snow has covered low shrubs and other grasses [31,83]. It has been identified as valuable winter forage [69,82,83]. However, cattle weight may decrease during use of basin wildrye [82].

Basin wildrye provides winter forage for elk and mule deer, though use is often low compared to other native grasses [13,83,116]. Trace amounts of basin wildrye may be present in the winter diet of bighorn sheep [75].
...
Basin wildrye is most palatable during the spring [71], and is fairly palatable to unpalatable for livestock during the winter grazing season [31,71]. Palatability of basin wildrye for livestock is rated as follows [37]:

Animal Colorado Montana Utah Wyoming Cattle fair good good good Domestic sheep fair fair fair good Horse fair good good good 
...
Month| Ether extract (%)| Total protein (%)| Lignin (%)| Cellulose (%)| Other carbohydrates (%)| Calcium (%)| Phosphorus (%)| Gross energy (cal/pound)| Carotene mg/pound 
---|---|---|---|---|---|---|---|---|--- 
...
Basin wildrye provides nesting cover for waterfowl [63] and upland game birds [129], including ring-necked pheasants [116]. The old stems of basin wildrye augmented by new growth afford fair protection [63]. Deer also utilize basin wildrye for bedding cover [116].
...
Basin wildrye is useful in mine reclamation [45,104,105], fire rehabilitation [104], and stabilizing disturbed areas [99,129]. Its usefulness in range seeding, however, may be limited by initially weak stand establishment [47].

Priming, a technique by which seeds are partially hydrated to a point where germination processes begin but radicle emergence does not occur, may be used to improve basin wildrye germination [61]. Priming of seeds can significantly (p<0.05) enhance germination rates of basin wildrye, increasing rates from 59% (unprimed) to 73% (primed) [60]. Priming may also reduce the number of days required for seeds to germinate; treatment for 8 days at 25 °C reduced the amount of time required to obtain 50% seed germination from 14.8 to 11.4 days [61]. Low-altitude sources of seed may have a broader usefulness in establishing stands of basin wildrye. Seeds from low altitude sources produce more seedheads than those from high altitude sources at lower altitude planting sites, while both sources produce approximately the same amount of seed heads at higher altitude planting sites [57].
...
Cold period (16 hr)| Warm period (8 hr) 
---|--- 
15 °C| 20 °C| 25 °C| 
10 °C| 86| 91| 87 
15 °C| 92| 97| 93 
 ...
 * K068 Wheatgrass-grama-buffalo grass [80]
 ...
 * 239 Pinyon-juniper
 * 249 Canyon live oak
 * 250 Blue oak-foothills pine [43]
 ...
 * 615 Wheatgrass-saltgrass-grama [114]

## References

1\. Abbott, Michael L.; Fraley, Leslie, Jr.; Reynolds, Timothy D. 1991. Root profiles of selected cold desert shrubs and grasses in disturbed and undisturbed soils. Environmental and Experimental Botany. 31(2): 165-178. [15472]
