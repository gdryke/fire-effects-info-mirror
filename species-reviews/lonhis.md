---
layout: default
title: Lonicera hispidula — pink honeysuckle
abbreviation: LONHIS
common_name: pink honeysuckle
...
Anderson, Michelle D. 2007. _Lonicera hispidula_ , pink honeysuckle. In: Fire Effects Information System, [Online]. U.S. Department of Agriculture, Forest Service, Rocky Mountain Research Station, Fire Sciences Laboratory (Producer). https://research.fs.usda.gov/feis/species-reviews/lonhis

## Introduction

## Taxonomy

The scientific name of pink honeysuckle is _Lonicera hispidula_ (Lindl.) Dougl. ex Torr. & Gray (Caprifoliaceae) [14,15,16]. Pink honeysuckle infrataxa are:

 * _Lonicera hispidula_ var. _hispidula_ [14,16]
 * _Lonicera hispidula_ var. _vacillans_ (Benth.) Gray [16]

### Synonyms

For _Lonicera hispidula_ var. _vacillans_ (Benth.) Gray

 * _Lonicera hispidula_ Douglas var. _vacillans_ A. Gray [14]
...
Photo © T. W. Carson, iNaturalist.org, some rights reserved. 

Pink honeysuckle ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>)).

In September of 2006 an extensive search was done to locate information on pink honeysuckle with little success (see [FEIS's list of source literature](<https://research.fs.usda.gov/feis/sources>)). Further research is needed on all aspects of pink honeysuckle.The following paragraphs provide details of what information was available.
...
Pink honeysuckle is a submontane to montane species. It grows in maritime to submaritime, summer-dry climates [18,34]. Pink honeysuckle is found on south or west aspects with gentle to moderate slopes [7,28]. It is characteristic of moisture-deficient sites and occurs sporadically on "water-shedding" sites [18,23]. Soils are generally very dry to moderately dry [7,18,33,34] and often acidic (pH 4.0-6.5) [34].

Pink honeysuckle is typical of California riparian areas, though more commonly found in coastal riparian areas than in Central Valley riparian areas [7,14,17,27]. It has been described as a wetland plant [16]. The elevation range for pink honeysuckle in California and Oregon is 1,500 to 3,500 feet (450-1,070 m) [35].
...
Pink honeysuckle flowers ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>)).
...
The Fire Regime table (table A1) provides fire regime information that may be relevant to pink honeysuckle habitats. For additional fire regime information, search FEIS for this species by entering the species name on the Advanced Search page and selecting “Fire Regime” as the publication type.
...
Photo © Robert A James, iNaturalist.org, some rights reserved. 

Pink honeysuckle fruits ([CC BY-NC 4.0](<https://creativecommons.org/licenses/by-nc/4.0/>)).
...
Pink honeysuckle is a foliar host for the pathogen sudden oak death mold (_Phytophthora ramorum_) which causes "sudden oak death", a deadly canker disease of tanoak (_Lithocarpus densiflorus_), coast live oak (_Quercus agrifolia_), California black oak (_Q. kelloggii_), and interior live oak (_Q. wislizenii_) in California and Oregon [12,22,26,30].

## Appendix

## Table A1: Fire Regime Table

Table A1—Fire regime information on vegetation communities in which pink honeysuckle may occur. This information is taken from the LANDFIRE Rapid Assessment Vegetation Models [20], which were developed by local experts using available literature, local data, and/or expert opinion. This table summarizes fire regime characteristics for each plant community listed. Dashes indicate that information was not available in the Rapid Assessment Vegetation Model.Vegetation Community 
...
1\. Agee, James K.; Finney, Mark; de Gouvenain, Roland. 1990. Forest fire history of Desolation Peak, Washington. Canadian Journal of Forest Research. 20: 350-356. [11035] 
